			...
			<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full min-w-0 mb-6">
				<div className="flex flex-col px-6 py-2 bg-white shadow rounded-lg">
					<div className="flex flex-col items-center space-y-2">
						<NumericFormat className="text-2xl font-bold tracking-tight leading-none text-purple-600" value={totalInterestPaid.toDP(2).toNumber()} displayType="text" prefix="$" thousandSeparator />
				...
				<div className="flex flex-col px-6 py-2 bg-white shadow rounded-lg">
					<div className="flex flex-col items-center space-y-2">
						<NumericFormat className="text-2xl font-bold tracking-tight leading-none text-green-600" value={totalPrincipalPaid.toDP(2).toNumber()} displayType="text" prefix="$" thousandSeparator />
				...
				<div className="flex flex-col px-6 py-2 bg-white shadow rounded-lg">
					<div className="flex flex-col items-center space-y-2">
						<NumericFormat className="text-2xl font-bold tracking-tight leading-none text-sky-600" value={totalAmountPaid.toDP(2).toNumber()} displayType="text" prefix="$" thousandSeparator />
